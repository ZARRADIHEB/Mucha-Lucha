...
const OrderBtn = ({ handleInitiatePaypalPayment, currentSelectedAddress }) => {
...
OrderBtn.propTypes = {
  handleInitiatePaypalPayment: PropTypes.func.isRequired,
  currentSelectedAddress: PropTypes.object,
};
